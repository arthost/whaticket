    ...
    const theme = createTheme(
        {
            ...
            palette: {
                type: mode,
                primary: { main: mode === "light" ? "#0329FF" : "#FFFFFF" },
				sair: { main: mode === "light" ? "#0329FF" : "#FFFFFF" },
				vcard: { main: mode === "light" ? "#0329FF" : "#666" },
                textPrimary: mode === "light" ? "#0329FF" : "#FFFFFF",
                borderPrimary: mode === "light" ? "#0329FF" : "#FFFFFF",
